...
const [bigShoeImg, setBigShoeImg] = useState(bigShoe1);
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28 xl:pl-10 sm:pl-10 pl-6">
        <p className="text-xl font-montserrat text-[#FF6452]">
          Our Summer Collection
        </p>
        <h1 className="mt-10 font-palanquin text-8xl font-bold max-sm:text-[72px] max-sm:leading-20.5  ">
